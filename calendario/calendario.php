...
function escribe_formulario_fecha_vacio($nombrecampo,$nombreformulario){
	...
	echo '
	 <div class="col-xs-12">
	<input name="'.$nombrecampo.'" class="form-control centrarTexto" type="text" placeholder="AAAA-MM-DD" required onkeypress="return soloLectura(event);" id="fechaNacimiento">
	</div>
	<a href="#"><img src="/infocentro/calendario/calendario.png" onclick="muestraCalendario(\''. $raiz.'\',\''. $nombreformulario .'\',\''.$nombrecampo.'\')"></a>
	';	
}
?>
        <script>
